 ...
 * and its exports follow that document's phases:
 *
 ...
 * - **Relinquish** — {@link clearLocalAccount} and {@link KEYSTORE_SECRET_IDS},
 *   the full set of secrets a factory reset must erase.
 *
