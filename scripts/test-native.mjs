...
// screen (principle #1: automate over manual). See `plans/testing/` for the strategy and
// `plans/testing/mobile-engine.md` for why this must run on a real device (expo-sqlite's
