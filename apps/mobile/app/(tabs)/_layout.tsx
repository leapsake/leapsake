...
/**
 * The app's bottom tab bar: the People & Pets home, global Search, and Settings.
 * Detail screens (people/[id], pets/[id], relationships, tags) and the "+ Add"
 * chooser live outside this group on the root stack, so navigating into one
 * pushes full-screen over the tabs — the standard pattern. This navigator owns
 * each tab's header (the root stack hides its own header for the `(tabs)` route
 * in app/_layout.tsx).
 *
