...
/**
 * The Reminders tab — a standalone list of user-created reminders (the seed of the
 * future home screen). Open reminders lead; completed ones sink to the bottom with
 * a struck-through label. Each row toggles completion and removes in place (the
 * list reloads without navigating). "+ Add" lives on the tab header
