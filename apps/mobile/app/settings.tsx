    ...
    <>
      ...
      <ScrollView contentContainerStyle={styles.screen}>
        ...
        {/*
          ...
          `plans/v0-1_08_local-notifications.md`) — a device gets a policy the
          moment it mints a local id, before any account exists — so this
          renders unconditionally, unlike the account-only pair below.
        */}
  ...
  return (
    <View style={{ marginTop: 24, gap: 8 }}>
      ...
      <Text style={styles.muted}>
        Get a nudge outside the app when a reminder is due — off by default, and
      ...
      {data.mode !== "off" && (
        <SelectField
          ...
          onChange={(value) => void setMine({ deliveryMinute: Number(value) })}
        />
      )}
      {permissionNotice !== null && (
        <View style={{ gap: 8 }}>
          <Text style={styles.danger} accessibilityRole="alert">
            Leapsake doesn't have permission to notify you on this phone, so
            these won't be delivered here.
          </Text>
