 ...
 * combined People & Pets list, and the Holidays catalog — plus Settings, which
 * isn't reachable from any entity. Within People & Pets, deeper navigation is
 * handled by that list and breadcrumbs.
 *
