...
| Work | Where |
|---|---|
| Building the SSR / PWA client — what the spike proved, and what an `apps/web` inherits *(the spike itself is done, 2026-08-15)* | [`../v0-1_web-spike.md`](../v0-1_web-spike.md) |
