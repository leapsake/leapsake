...
| Build the holidays observance-authoring UI (next up) | [`holidays/observance-authoring.md`](./holidays/observance-authoring.md) — the autocomplete redesign + everything a cold start needs |
