...
| **Remove or simplify code without a user-visible change**         | [`fable-investigation/`](./fable-investigation/README.md) — the decided workstreams (comment pass, shared form hooks, CI tiers, remote releases), each deleted when it lands                                                                                                                                      |
