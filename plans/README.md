...
| **Design the first-run experience — nudges, snooze, dismissals** | [`onboarding.md`](./onboarding.md) — the standing nudges + their increments. Read it before touching `ONBOARDING_STEPS` or the reminder-row actions |
