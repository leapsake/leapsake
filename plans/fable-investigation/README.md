...
| 3   | [`ci-and-test-tiers.md`](./ci-and-test-tiers.md) | E2E flows proving what a lower tier should: door negatives, form state, query behaviour, navigation config. Steps 1–3, 4a, 4b, 5, 6 and 6a landed (the arc is three flows; Forget account is proven in Vitest); 7a, 7b and 7d landed; 7c retires the last one-off flow. | **Do it.** Admission rule in `testing/crucial-flows.md`; step 4 decided 2026-09-24 (release build, iOS then Android); 4a, 4b, 5, 6, 6a, 7a, 7b and 7d landed 2026-09-24. |
