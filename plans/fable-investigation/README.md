...
| 3   | [`ci-and-test-tiers.md`](./ci-and-test-tiers.md) | E2E flows proving what a lower tier should: door negatives, form state, query behaviour, navigation config. Steps 1–3, 4a, 4b, 5 and 6 landed (the arc is three flows); 6a moves Forget account below E2E; 7 retires the four one-off flows. | **Do it.** Admission rule in `testing/crucial-flows.md`; step 4 decided 2026-09-24 (release build, iOS then Android); 4a, 4b, 5 and 6 landed 2026-09-24. |
